...
import { getTopNewProducts, getTopSellingProducts, getFurnitureProducts } from "utils/api/furniture-shop/products";
...
const FurnitureShop = props => {
  ...
  return <GroceryLayout showNavbar={false}>
        ...
        <Box>
          ...
          mb: 6
            ...
            <Box className="sidenav">
              <GiftFurnitureSideNav bgColor={palette.primary[50]} contentColor={palette.primary} navList={furnitureShopNavList} sidebarHeight="85vh" />
            </Box>
      ...
      <MobileNavigationBar2>
        <GiftFurnitureSideNav bgColor={palette.primary[50]} contentColor={palette.primary} navList={furnitureShopNavList} sidebarHeight="100%" />
      </MobileNavigationBar2>
    </GroceryLayout>;
};
