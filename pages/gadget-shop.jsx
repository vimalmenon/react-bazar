...
import { getTopPicksList, getMainCarousel, getMostViewedList } from "utils/api/gadget-shop/carousels";
import { getTwoBanner, getBlogLists, getFeaturedCategories } from "utils/api/gadget-shop/sections";
