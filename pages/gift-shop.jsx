...
import { getGiftShopProducts, getPopularProducts, getTopSailedProducts } from "utils/api/gift-shop/products";
import { getGiftShopServiceList, getGiftShopTopCategories } from "utils/api/gift-shop/servicesAndCategories";
...
const HealthAndBeauty = props => {
  ...
  return <GroceryLayout showNavbar={false}>
      <Box id="groceryMain">
        <GiftShopSection1 />
      </Box>
      <Container>
        <Box>
          ...
          mb: 8
            ...
            <Box className="sidenav">
              <GiftFurnitureSideNav bgColor={palette.primary[100]} contentColor={palette.primary} navList={giftShopNavList} sidebarHeight="85vh" />
            </Box>
      ...
      <PageFooter id="footer" sx={{
      borderRadius: "none"
    }} bgcolor={palette.primary.main} />

      <MobileNavigationBar2>
        <GiftFurnitureSideNav bgColor={palette.primary[100]} contentColor={palette.primary} navList={giftShopNavList} sidebarHeight="100%" />
      </MobileNavigationBar2>
    </GroceryLayout>;
};
