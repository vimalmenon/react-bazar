...
const TrendingProducts = ({
  ...
  return <CategorySectionCreator title="Trending Products" seeMoreLink="#">
      <SubTitle>Best collection in 2021 for you!</SubTitle>
      <Box mb={-0.5}>
        <Carousel infinite={true} totalSlides={productsData.length} visibleSlides={visibleSlides} sx={{
