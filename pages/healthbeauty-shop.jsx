...
import { getTopNewProducts, getHealthBeautyProducts } from "utils/api/healthbeauty-shop/products";
...
const HealthAndBeauty = props => {
  ...
  return <GroceryLayout>
      ...
      <SidenavContainer navFixedComponentID={"healthBeautySection1"} SideNav={() => <HealthBeautySidenav navList={healthBeautyNavList} />}>
        <Box mb={6}>
