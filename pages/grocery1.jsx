...
import { getGrocery1Products, getPopularProducts, getTrendingProducts } from "utils/api/grocery1-shop/products";
...
const Grocery1 = props => {
  ...
  return <GroceryLayout showNavbar={false}>
      ...
      <SidenavContainer navFixedComponentID={"grocery1Services"} SideNav={() => <Grocery1SideNav navList={grocery1NavList} />}>
        <Box mb={6} mt={3}>
